...
['ClassBondPanel', {bond: '_ shares my hunger for glory, the earth will tremble at our passing!' } ]
    ...
    new ClassMovePanel(topPanel, {source: "Kickstarter 2012", className: "The Barbarian", minLevel: "Starting", maxLevel: 2, name: "Musclebound", move: "While you wield a weapon it gains the forceful and messy tags.", prerequisiteType: "None", prerequisite: "" });
    ...
    new ClassMovePanel(topPanel, {source: "Kickstarter 2012", className: "The Barbarian", minLevel: 1, maxLevel: 2, name: "Full Plate and Packing Steel", move: "You ignore the clumsy tag on armor you wear. ", prerequisiteType: "None", prerequisite: "" });

    new ClassMovePanel(topPanel, {source: "Kickstarter 2012", className: "The Barbarian", minLevel: 1, maxLevel: 2, name: "Unencumbered, Unharmed", move: "So long as you are below your Load and neither wear armor nor carry a shield, take +1 armor.", prerequisiteType: "None", prerequisite: "" });

    new ClassMovePanel(topPanel, {source: "Kickstarter 2012", className: "The Barbarian", minLevel: 2, maxLevel: 10, name: "Still Hungry", move: "Choose an additional appetite.", prerequisiteType: "None", prerequisite: "" });

    new ClassMovePanel(topPanel, {source: "Kickstarter 2012", className: "The Barbarian", minLevel: 2, maxLevel: 10, name: "Appetite for Destruction", move: "Take a move from the fighter, bard or thief class list. You may not take multiclass moves from those classes.", prerequisiteType: "None", prerequisite: "" });

    new ClassMovePanel(topPanel, {source: "Kickstarter 2012", className: "The Barbarian", minLevel: 2, maxLevel: 10, name: "My Love For You Is Like a Truck", move: "When you perform a feat of strength, name someone present who you have impressed and take +1 forward to parley with them.", prerequisiteType: "None", prerequisite: "" });
    ...
    new ClassMovePanel(topPanel, {source: "Kickstarter 2012", className: "The Barbarian", minLevel: 2, maxLevel: 10, name: "Khan of Khans", move: "Your hirelings always accept the gratuitous fulfillment of one of your appetites as payment.", prerequisiteType: "None", prerequisite: "" });

    new ClassMovePanel(topPanel, {source: "Kickstarter 2012", className: "The Barbarian", minLevel: 2, maxLevel: 10, name: "Samson", move: "You may take a debility to immediately break free of any physical or mental restraint.", prerequisiteType: "None", prerequisite: "" });

    new ClassMovePanel(topPanel, {source: "Kickstarter 2012", className: "The Barbarian", minLevel: 2, maxLevel: 10, name: "Smash!", move: "When you hack and slash, on a 12+ deal your damage and choose something physical your target has (a weapon, their position, a limb): they lose it.", prerequisiteType: "None", prerequisite: "" });
    ...
    new ClassMovePanel(topPanel, {source: "Kickstarter 2012", className: "The Barbarian", minLevel: 6, maxLevel: 10, name: "A Good Day to Die", move: "As long as you have less than your Con in current HP (or 1, whichever is higher) take +1 ongoing.", prerequisiteType: "None", prerequisite: "" });

    new ClassMovePanel(topPanel, {source: "Kickstarter 2012", className: "The Barbarian", minLevel: 6, maxLevel: 10, name: "Kill 'em All", move: "Take another move from the Fighter, Bard or Thief class list. You may not take multiclass moves from those classes.", prerequisiteType: "Requires", prerequisite: "Appetite for Destruction" });
    ...
    new ClassMovePanel(topPanel, {source: "Kickstarter 2012", className: "The Barbarian", minLevel: 6, maxLevel: 10, name: "The One Who Knocks", move: "When you defy danger, on a 12+ you turn the danger back on itself, the GM will describe how.", prerequisiteType: "None", prerequisite: "" });
